...
class MyPanel extends JPanel implements KeyListener, Runnable {
	...
	public void paint(Graphics g) {
		...
		// 画出子弹(子弹横坐标，子弹纵坐标，子弹宽，子弹高)
		if (hero.s != null && hero.s.isLive == true) {// 如果子弹不存在
			g.drawRect(hero.s.x, hero.s.y, 1, 1);
		}
...
public class MyTankGame2_1 extends JFrame {
	...
	public static void main(String[] args) {
		...
		MyTankGame2_1 mtg = new MyTankGame2_1();
	}

	// 构造函数
	public MyTankGame2_1() {
